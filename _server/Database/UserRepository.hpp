...
public:
    ...
    virtual std::vector<std::list<std::string>> getByField(const std::string &fieldName, const std::string &value) const override;
    virtual std::vector<std::list<std::string>> getAll() const override;
