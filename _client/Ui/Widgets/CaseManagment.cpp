...
void CaseManagment::init()
{
    ...
    m_manageDocs->setMaximumSize(Button::WIDTH, Button::HEIGHT);
    m_manageDocs->resize(Button::WIDTH, Button::HEIGHT);
    ...
    m_buttonStack->addWidget(m_manageDocs);
...
void CaseManagment::connectButtons()
{
    ...
    connect(m_manageDocs, &QPushButton::clicked, this, &CaseManagment::onManageDocsClicked);
...
void CaseManagment::onManageDocsClicked()
{
    qDebug() << "LOG: CaseManagment::onManageDocsClicked";
    emit manageDocs();
}
